object FrmTerceirizadoLancaFinanceiro: TFrmTerceirizadoLancaFinanceiro
  ...
  object db_TerceirizadosReferencias: TUniQuery
    Connection = FrmPrincipal.DBConexao
    SQL.Strings = (
  ...
  object db_Terceirizados: TUniQuery
    Connection = FrmPrincipal.DBConexao
    SQL.Strings = (
    ...
    object db_TerceirizadosDATA: TDateTimeField
      FieldName = 'DATA'
      EditMask = '99/99/9999'
    end
    object db_TerceirizadosDATARETORNO: TDateTimeField
      FieldName = 'DATARETORNO'
      EditMask = '99/99/9999'
    end
  ...
  object dbView_Terceirizados: TUniQuery
    Connection = FrmPrincipal.DBConexao
    SQL.Strings = (
      'SELECT * FROM VIEW_TERCEIRIZADOPAGAR'
      'WHERE'
  ...
  object db_Somar: TUniQuery
    ...
    object db_SomarVLR_TOTAL: TFloatField
      FieldName = 'VLR_TOTAL'
      ReadOnly = True
    end
  end
