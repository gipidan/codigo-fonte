object FrmHistoricoFuncionario: TFrmHistoricoFuncionario
  ...
  object db_Departamento: TUniQuery
    Connection = FrmPrincipal.DBConexao
    SQL.Strings = (
  ...
  object db_CaixaFuncionarios: TUniQuery
    Connection = FrmPrincipal.DBConexao
    SQL.Strings = (
  ...
  object db_Vendedores: TUniQuery
    Connection = FrmPrincipal.DBConexao
    SQL.Strings = (
  ...
  object db_IncluirSequencia: TUniQuery
    Connection = FrmPrincipal.DBConexao
    SQL.Strings = (
  ...
  object db_ChecarSequencia: TUniQuery
    Connection = FrmPrincipal.DBConexao
    SQL.Strings = (
