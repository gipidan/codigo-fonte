...
uses
   ...
   FFrameBotoes, DBAccess, ShellAPI, FFrameBarra;

type
   TFrmRepresentantes = class(TForm)
      GroupBox1: TGroupBox;
      DS_Vendedor: TDataSource;
      db_Vendedor: TUniQuery;
    ...
    db_VendedorDATA: TDateTimeField;
    db_VendedorDATA_NASCIMENTO: TDateTimeField;
    db_VendedorDATA_ULTIMA_VENDA: TDateTimeField;
    ...
    db_VendedorPROTESTO_DATA: TDateTimeField;
    ...
    db_VendedorULTIMAVENDA_DATA: TDateTimeField;
    db_VendedorULTIMAVENDA_ORIGEM: TStringField;
    db_VendedorATIVODATA: TDateTimeField;
    GroupBox4: TGroupBox;
    Label6: TLabel;
    Label4: TLabel;
    Label1: TLabel;
