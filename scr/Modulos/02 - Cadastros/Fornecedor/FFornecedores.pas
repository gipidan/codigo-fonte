...
uses
   ...
   Buttons, ExtCtrls, StdCtrls, Menus, Mask, DBCtrls, DB, BTOdeum, ShellApi,
   MemDS, Uni, ComCtrls, Grids, DBGrids,
    ISFEdit, ISFEditbtn, ISFdbEditbtn,  IDBEdit,
   uEstSearchDialogZeos, FFrameBotoes, FFrameBarra, DBAccess;

type
   TFrmFornecedores = class(TForm)
      DS_Fornecedor: TDataSource;
      db_Fornecedor: TUniQuery;
      ...
      db_FornecedorCREDITO_LIMITE: TFloatField;
      db_FornecedorCREDITO_UTILIZADO: TFloatField;
      db_FornecedorCREDITO_DISPONIVEL: TFloatField;
      ...
      db_FornecedorCOMISSAO: TFloatField;
      db_FornecedorCOMISSIONAR: TStringField;
      db_FornecedorSALARIO: TFloatField;
      ...
      DBEdit13: TDBEdit;
      DBEdit14: TDBEdit;
      db_FornecedorDATA: TDateTimeField;
      db_FornecedorDATA_NASCIMENTO: TDateTimeField;
      db_FornecedorPROTESTO_DATA: TDateTimeField;
    ...
    db_FornecedorVALOR_SERVICOS: TFloatField;
    ...
    DBEdit17: TDBEdit;
    db_FornecedorATIVODATA: TDateTimeField;
    db_FornecedorULTIMAVENDA_DATA: TDateTimeField;
