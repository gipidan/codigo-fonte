object FrmFornecedores: TFrmFornecedores
  ...
  object db_Fornecedor: TUniQuery
    Connection = FrmPrincipal.DBConexao
    SQL.Strings = (
      'SELECT * FROM CAD_CLIENTES'
      'WHERE'
    ...
    object db_FornecedorDATA: TDateTimeField
      FieldName = 'DATA'
    end
    object db_FornecedorDATA_NASCIMENTO: TDateTimeField
    ...
    object db_FornecedorCREDITO_LIMITE: TFloatField
      FieldName = 'CREDITO_LIMITE'
    end
    object db_FornecedorCREDITO_UTILIZADO: TFloatField
      FieldName = 'CREDITO_UTILIZADO'
    end
    object db_FornecedorCREDITO_DISPONIVEL: TFloatField
    ...
    object db_FornecedorPROTESTO_DATA: TDateTimeField
    ...
    object db_FornecedorCOMISSAO: TFloatField
      FieldName = 'COMISSAO'
    end
    ...
    object db_FornecedorSALARIO: TFloatField
      FieldName = 'SALARIO'
    end
    ...
    object db_FornecedorVALOR_SERVICOS: TFloatField
      FieldName = 'VALOR_SERVICOS'
      DisplayFormat = '###,##0.0000'
      EditFormat = '###,##0.0000'
    end
    object db_FornecedorATIVODATA: TDateTimeField
      FieldName = 'ATIVODATA'
      EditMask = '99/99/9999'
    end
    object db_FornecedorULTIMAVENDA_DATA: TDateTimeField
