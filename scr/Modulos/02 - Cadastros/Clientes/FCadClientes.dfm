object FrmClientes: TFrmClientes
  ...
  object db_ctareceber: TUniQuery
    ...
    object db_ctareceberCONTACAIXASALDOINICIAL: TFloatField
    ...
    object db_ctareceberDESPESAS_OUTRAS: TFloatField
    ...
    object db_ctareceberVALOR_DIFERENCA: TFloatField
  ...
  object db_ctareceberSum: TUniQuery
    Connection = FrmPrincipal.DBConexao
    SQL.Strings = (
      'SELECT '
  ...
  object db_ViewCliente: TUniQuery
    Connection = FrmPrincipal.DBConexao
    SQL.Strings = (
      'SELECT *  FROM VIEW_CLIENTES'
      'WHERE'
