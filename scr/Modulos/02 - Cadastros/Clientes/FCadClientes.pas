...
uses
   ...
   MemDS, Uni, BTOdeum, Buttons, ExtDlgs,
   Menus,  FFrameBarra, ISFEdit, ISFEditbtn,
   ISFdbEditbtn,  uEstSearchDialogZeos,
   FFrameBotoes, IDBEdit, Spin, DBAccess, frxClass, frxDBSet,
   Classe.Global;
...
type
   TFrmClientes = class(TForm)
    ...
    db_ctareceberCONTACAIXASALDOINICIAL: TFloatField;
    ...
    db_ctareceberDESPESAS_OUTRAS: TFloatField;
    ...
    db_PedidoSum: TUniQuery;
    db_ctareceberSum: TUniQuery;
    ...
    db_ctareceberVALOR_DIFERENCA: TFloatField;
