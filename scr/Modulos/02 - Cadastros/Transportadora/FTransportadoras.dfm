object FrmTransportadoras: TFrmTransportadoras
  ...
  object db_Transportadora: TUniQuery
    Connection = FrmPrincipal.DBConexao
    SQL.Strings = (
      'SELECT * FROM CAD_CLIENTES'
      'WHERE'
    ...
    object db_TransportadoraDATA: TDateTimeField
      FieldName = 'DATA'
      EditMask = '99/99/9999'
    end
    object db_TransportadoraDATA_NASCIMENTO: TDateTimeField
      FieldName = 'DATA_NASCIMENTO'
    end
    object db_TransportadoraDATA_ULTIMA_VENDA: TDateTimeField
    ...
    object db_TransportadoraPROTESTO_DATA: TDateTimeField
    ...
    object db_TransportadoraVALOR_SERVICOS: TFloatField
