object FrmPedidoAprovarVenda: TFrmPedidoAprovarVenda
  ...
  object SP_Aprovar: TUniStoredProc
    ...
    CommandStoredProcName = 'SPVENDA_PEDIDOAPROVAR'
  end
  object SP_MovimentoAtualizar: TUniStoredProc
  ...
  object db_ChecarAtrasos: TUniQuery
    Connection = FrmPrincipal.DBConexao
    SQL.Strings = (
