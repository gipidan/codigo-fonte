...
uses
   ...
   BTOdeum, Grids, DBGrids, MemDS, Uni,
   DBAccess, frxClass, frxDBSet, FFrameBarra, ISFEdit, ISFEditbtn, ISFdbEditbtn,
  IDBEdit, uEstSearchDialogZeos, Classe.Global;

type
   TFrmEtiquetacaixa = class(TForm)
    db_notasfiscais: TUniQuery;
    ...
    db_notasfiscaisDATA: TDateTimeField;
