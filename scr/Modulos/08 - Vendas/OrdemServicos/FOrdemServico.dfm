object FrmOrdemServico: TFrmOrdemServico
  ...
  object pgcPrincipal: TPageControl
    ...
    object tabPrincipal: TTabSheet
      ...
      ExplicitWidth = 0
      ExplicitHeight = 0
      object grpPrincipal: TAdvGroupBox
        Left = 0
        Top = 0
        Width = 1020
        Height = 338
        ...
        TabOrder = 0
        ExplicitWidth = 1040
        object GrupoProdutos: TAdvGroupBox
          Left = 3
          Top = 176
          Width = 1014
          Height = 159
        ...
        object grpDetalhesOS: TAdvGroupBox
          Left = 3
          Top = 17
          Width = 1014
          Height = 159
  ...
  object SP_CalculaOrdemServicos: TUniStoredProc
    ...
    CommandStoredProcName = 'SPORDEMSERVICOS_CALCULA;1'
  end
  ...
  object db_PedidoTerceiros: TUniQuery
    Connection = FrmPrincipal.DBConexao
    SQL.Strings = (
  ...
  object db_DetalhesServicos: TUniQuery
    Connection = FrmPrincipal.DBConexao
    SQL.Strings = (
    ...
    object db_DetalhesServicosDATA: TDateTimeField
      FieldName = 'DATA'
    end
    ...
    object db_DetalhesServicosQTDE: TFloatField
      FieldName = 'QTDE'
      DisplayFormat = '###,##0'
      EditFormat = '###,##0'
    end
    object db_DetalhesServicosVLR_UNIT: TFloatField
      FieldName = 'VLR_UNIT'
      DisplayFormat = '###,##0.00'
      EditFormat = '###,##0.00'
    end
    object db_DetalhesServicosDESCONTO: TFloatField
      FieldName = 'DESCONTO'
      DisplayFormat = '###,##0.00'
      EditFormat = '###,##0.00'
    end
    object db_DetalhesServicosVLR_DESCONTO: TFloatField
      FieldName = 'VLR_DESCONTO'
      DisplayFormat = '###,##0.00'
      EditFormat = '###,##0.00'
    end
    object db_DetalhesServicosVLR_TOTAL: TFloatField
      FieldName = 'VLR_TOTAL'
      DisplayFormat = '###,##0.00'
      EditFormat = '###,##0.00'
    end
  ...
  object db_DetalhesTerceiros: TUniQuery
    Connection = FrmPrincipal.DBConexao
    SQL.Strings = (
    ...
    object db_DetalhesTerceirosDATA: TDateTimeField
      FieldName = 'DATA'
      Required = True
    end
    ...
    object db_DetalhesTerceirosQTDE: TFloatField
      FieldName = 'QTDE'
      DisplayFormat = '###,##0'
      EditFormat = '###,##0'
    end
    object db_DetalhesTerceirosVLR_UNIT: TFloatField
      FieldName = 'VLR_UNIT'
      DisplayFormat = '###,##0.00'
      EditFormat = '###,##0.00'
    end
    object db_DetalhesTerceirosDESCONTO: TFloatField
      FieldName = 'DESCONTO'
      DisplayFormat = '###,##0.00'
      EditFormat = '###,##0.00'
    end
    object db_DetalhesTerceirosVLR_DESCONTO: TFloatField
      FieldName = 'VLR_DESCONTO'
      DisplayFormat = '###,##0.00'
      EditFormat = '###,##0.00'
    end
    object db_DetalhesTerceirosVLR_TOTAL: TFloatField
      FieldName = 'VLR_TOTAL'
      DisplayFormat = '###,##0.00'
      EditFormat = '###,##0.00'
    end
