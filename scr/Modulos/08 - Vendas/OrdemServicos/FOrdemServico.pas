...
type
   TFrmOrdemServico = class(TForm)
    ...
    SP_CalculaOrdemServicos: TUniStoredProc;
    ...
    grpPrincipal: TAdvGroupBox;
    GrupoProdutos: TAdvGroupBox;
    dbGrid_Produtos: TDBGrid;
    ProgressBar1: TProgressBar;
    grpDetalhesOS: TAdvGroupBox;
    Label1: TLabel;
    Label2: TLabel;
    Label3: TLabel;
    Label4: TLabel;
    ...
    db_DetalhesTerceirosQTDE: TFloatField;
    db_DetalhesTerceirosVLR_UNIT: TFloatField;
    db_DetalhesTerceirosDESCONTO: TFloatField;
    db_DetalhesTerceirosVLR_DESCONTO: TFloatField;
    db_DetalhesTerceirosVLR_TOTAL: TFloatField;
    ...
    db_DetalhesServicosDATA: TDateTimeField;
    ...
    db_DetalhesServicosQTDE: TFloatField;
    db_DetalhesServicosVLR_UNIT: TFloatField;
    db_DetalhesServicosDESCONTO: TFloatField;
    db_DetalhesServicosVLR_DESCONTO: TFloatField;
    db_DetalhesServicosVLR_TOTAL: TFloatField;
