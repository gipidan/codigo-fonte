object FrmConsultaNotaFiscal: TFrmConsultaNotaFiscal
  ...
  object db_Vendas: TUniQuery
    ...
    object db_VendasDATA_ES: TDateTimeField
      FieldName = 'DATA_ES'
    end
    ...
    object db_VendasNF_VALOR_TOTAL: TFloatField
      FieldName = 'NF_VALOR_TOTAL'
      DisplayFormat = '###,##0.00'
    end
    object db_VendasNF_VALOR_PRODUTOS: TFloatField
      FieldName = 'NF_VALOR_PRODUTOS'
      DisplayFormat = '###,##0.00'
    end
    ...
    object db_VendasNF_VALOR_ICMS: TFloatField
      FieldName = 'NF_VALOR_ICMS'
    end
    object db_VendasNF_VALOR_IPI: TFloatField
      FieldName = 'NF_VALOR_IPI'
    end
    object db_VendasNF_ISS: TFloatField
      FieldName = 'NF_ISS'
    end
    object db_VendasNF_ISS_VALOR: TFloatField
      FieldName = 'NF_ISS_VALOR'
    end
    object db_VendasNF_BASE_CALC_ICMS: TFloatField
      FieldName = 'NF_BASE_CALC_ICMS'
    end
    object db_VendasNF_BASE_CALC_ICMS_II: TFloatField
      FieldName = 'NF_BASE_CALC_ICMS_II'
    end
    object db_VendasNF_VALOR_BASE_ICMS_II: TFloatField
    ...
    object db_VendasVLR_DESP_ACES: TFloatField
      FieldName = 'VLR_DESP_ACES'
    end
    object db_VendasPERC_DESCONTO: TFloatField
    ...
    object db_VendasTRANSP_PBRUTO: TFloatField
      FieldName = 'TRANSP_PBRUTO'
    end
    object db_VendasTRANSP_PLIQUIDO: TFloatField
    ...
    object db_VendasALIQ_ICMS_REDUCAO: TFloatField
      FieldName = 'ALIQ_ICMS_REDUCAO'
    end
    object db_VendasVLR_ICMS_REDUCAO: TFloatField
  ...
  object db_VendasItens: TUniQuery
    ...
    object db_VendasItensQTDE: TFloatField
      FieldName = 'QTDE'
      DisplayFormat = '###,##0'
    end
    object db_VendasItensVLR_UNITARIO: TFloatField
      FieldName = 'VLR_UNITARIO'
      DisplayFormat = '###,##0.00'
    end
    ...
    object db_VendasItensIPI_ALIQUOTA: TFloatField
      FieldName = 'IPI_ALIQUOTA'
      DisplayFormat = '###,##0.00'
    end
    ...
    object db_VendasItensICMS_ALIQUOTA: TFloatField
      FieldName = 'ICMS_ALIQUOTA'
      DisplayFormat = '###,##0.00'
    end
    ...
    object db_VendasItensDESCONTO_VALOR: TFloatField
