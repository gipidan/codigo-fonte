object FrmNotaFiscalProcessamento: TFrmNotaFiscalProcessamento
  ...
  object db_Vendas_NFE: TUniQuery
    Connection = FrmPrincipal.DBConexao
    SQL.Strings = (
      'SELECT * FROM VENDAS'
      'WHERE'
    ...
    object db_Vendas_NFEEMISSAO: TDateTimeField
      FieldName = 'EMISSAO'
      ReadOnly = True
      Required = True
    end
    ...
    object db_Vendas_NFEDATA_ENTRADASAIDA: TDateTimeField
    ...
    object db_Vendas_NFEICMS_BASECALCULO: TFloatField
      FieldName = 'ICMS_BASECALCULO'
      ReadOnly = True
    end
    object db_Vendas_NFEICMS_VALOR: TFloatField
      FieldName = 'ICMS_VALOR'
      ReadOnly = True
    end
    object db_Vendas_NFEICMS_BASECALCULO_SUBSTITUICAO: TFloatField
      FieldName = 'ICMS_BASECALCULO_SUBSTITUICAO'
      ReadOnly = True
    end
    object db_Vendas_NFEICMS_BASECALCULO_SUBSTITUICAO_VALOR: TFloatField
      FieldName = 'ICMS_BASECALCULO_SUBSTITUICAO_VALOR'
      ReadOnly = True
    end
    object db_Vendas_NFEICMS_REDUCAO: TFloatField
      FieldName = 'ICMS_REDUCAO'
      ReadOnly = True
    end
    object db_Vendas_NFEICMS_REDUCAO_VALOR: TFloatField
      FieldName = 'ICMS_REDUCAO_VALOR'
      ReadOnly = True
    end
    object db_Vendas_NFEIPI_BASECALCULO: TFloatField
      FieldName = 'IPI_BASECALCULO'
      ReadOnly = True
    end
    object db_Vendas_NFEIPI_VALOR: TFloatField
      FieldName = 'IPI_VALOR'
      ReadOnly = True
    end
    object db_Vendas_NFEISS: TFloatField
      FieldName = 'ISS'
      ReadOnly = True
    end
    object db_Vendas_NFEISS_BASECALCULO: TFloatField
      FieldName = 'ISS_BASECALCULO'
      ReadOnly = True
    end
    object db_Vendas_NFEISS_VALOR: TFloatField
      FieldName = 'ISS_VALOR'
      ReadOnly = True
    end
    object db_Vendas_NFESIMPLESNACIONAL_ALIQUOTA: TFloatField
      FieldName = 'SIMPLESNACIONAL_ALIQUOTA'
      ReadOnly = True
    end
    object db_Vendas_NFESIMPLESNACIONAL_VALOR: TFloatField
      FieldName = 'SIMPLESNACIONAL_VALOR'
      ReadOnly = True
    end
    object db_Vendas_NFEVLR_FRETE: TFloatField
      FieldName = 'VLR_FRETE'
      ReadOnly = True
    end
    object db_Vendas_NFEVLR_SEGURO: TFloatField
      FieldName = 'VLR_SEGURO'
      ReadOnly = True
    end
    object db_Vendas_NFEVLR_DESPESAS_ASSESSORIAS: TFloatField
      FieldName = 'VLR_DESPESAS_ASSESSORIAS'
      ReadOnly = True
    end
    object db_Vendas_NFEDESCONTO: TFloatField
      FieldName = 'DESCONTO'
      ReadOnly = True
    end
    object db_Vendas_NFEVLR_DESCONTO: TFloatField
      FieldName = 'VLR_DESCONTO'
      ReadOnly = True
    end
    object db_Vendas_NFEVLR_RECEBIDO: TFloatField
      FieldName = 'VLR_RECEBIDO'
      ReadOnly = True
    end
    object db_Vendas_NFEVLR_CARTAO: TFloatField
      FieldName = 'VLR_CARTAO'
      ReadOnly = True
    end
    object db_Vendas_NFETROCO: TFloatField
      FieldName = 'TROCO'
      ReadOnly = True
    end
    object db_Vendas_NFEVLR_CAIXA: TFloatField
      FieldName = 'VLR_CAIXA'
      ReadOnly = True
    end
    ...
    object db_Vendas_NFEFRETE_PBRUTO: TFloatField
      FieldName = 'FRETE_PBRUTO'
      ReadOnly = True
    end
    object db_Vendas_NFEFRETE_PLIQUIDO: TFloatField
    ...
    object db_Vendas_NFEVALOR_PRODUTOS: TFloatField
      FieldName = 'VALOR_PRODUTOS'
      ReadOnly = True
    end
    object db_Vendas_NFETOTAL_NF: TFloatField
      FieldName = 'TOTAL_NF'
      ReadOnly = True
    end
    ...
    object db_Vendas_NFECREDITOABATIMENTO: TFloatField
    ...
    object db_Vendas_NFENFE_DATATRANSMISSAO: TDateTimeField
    ...
    object db_Vendas_NFECANCELAMENTO_DATA: TDateTimeField
