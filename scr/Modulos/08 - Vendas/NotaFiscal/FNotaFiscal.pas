...
uses
   ...
   DBGrids, MemDS, Uni, AdvEdit,
   AdvMoneyEdit, DBAdvMoneyEdit, Buttons, ACBrNFeDANFEClass,
   ACBrNFe, pcnConversao, DBAccess,
   Classe.Global;
...
type
   TFrmNotaFiscal = class(TForm)
    ...
    db_PedidosConferencia: TUniQuery;
    db_PedidosConferenciaItens: TUniQuery;
...
begin
   ...
   if pergunta('Esse processo irá gerar dados reais no servidor da SEFAZ'+#13+#10+
