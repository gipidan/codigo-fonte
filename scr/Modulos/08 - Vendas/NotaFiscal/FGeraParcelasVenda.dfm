object FrmGeraParcelasVenda: TFrmGeraParcelasVenda
  ...
  object db_FormaPagto: TUniQuery
    Connection = FrmPrincipal.DBConexao
    SQL.Strings = (
      'SELECT'
      'A.*, B.*'
  ...
  object db_CtaReceberSomar: TUniQuery
    Connection = FrmPrincipal.DBConexao
    SQL.Strings = (
  ...
  object SPCLIENTE_ATUALIZACREDITO: TUniStoredProc
    ...
    CommandStoredProcName = 'SPCLIENTE_ATUALIZACREDITO'
  end
end
