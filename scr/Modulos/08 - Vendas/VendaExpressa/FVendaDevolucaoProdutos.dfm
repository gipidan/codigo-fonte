object FrmVendaDevolucaoProdutos: TFrmVendaDevolucaoProdutos
  ...
  object db_VendasOrigem: TUniQuery
    Connection = FrmPrincipal.DBConexao
    SQL.Strings = (
      'SELECT * FROM VENDAS'
      'where'
    ...
    object db_VendasOrigemEMISSAO: TDateTimeField
      FieldName = 'EMISSAO'
      Required = True
      EditMask = '99/99/9999'
    end
    ...
    object db_VendasOrigemDATA_ENTRADASAIDA: TDateTimeField
    ...
    object db_VendasOrigemNFE_DATATRANSMISSAO: TDateTimeField
  ...
  object SPNFE_DEVOLVER: TUniStoredProc
    ...
    CommandStoredProcName = 'SPNFE_DEVOLVER'
  end
  ...
  object db_VendasDevolucao: TUniQuery
    Connection = FrmPrincipal.DBConexao
    SQL.Strings = (
      'SELECT * FROM VENDAS'
      'where'
  ...
  object db_deletarRegistrosIncompletos: TUniQuery
    Connection = FrmPrincipal.DBConexao
    SQL.Strings = (
      'DELETE FROM VENDAS'
      'WHERE'
  ...
  object db_ViewNotaFiscal: TUniQuery
    Connection = FrmPrincipal.DBConexao
    SQL.Strings = (
      'SELECT  * FROM VIEW_NOTAFISCAL'
      'WHERE'
  ...
  object db_ViewNotaFiscalItens: TUniQuery
    Connection = FrmPrincipal.DBConexao
    SQL.Strings = (
