object FrmRelBanco_FluxoBancario: TFrmRelBanco_FluxoBancario
  ...
  object db_MovtoBancario: TUniQuery
    SQL.Strings = (
  ...
  object db_CtaCorrente: TUniQuery
    SQL.Strings = (
  ...
  object DB_SaldoCta: TUniQuery
    ...
    object DB_SaldoCtaCREDITO: TFloatField
      FieldName = 'CREDITO'
    end
    object DB_SaldoCtaDEBITO: TFloatField
      FieldName = 'DEBITO'
    end
    object DB_SaldoCtaSALDO: TFloatField
      FieldName = 'SALDO'
    end
