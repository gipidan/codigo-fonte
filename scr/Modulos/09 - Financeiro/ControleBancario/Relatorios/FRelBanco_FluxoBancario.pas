...
type
   TFrmRelBanco_FluxoBancario = class(TForm)
      ...
      db_bancos: TUniQuery;
      db_CtaCorrente: TUniQuery;
      DB_SaldoCta: TUniQuery;
      ...
      DB_SaldoCtaCREDITO: TFloatField;
      DB_SaldoCtaDEBITO: TFloatField;
      DB_SaldoCtaSALDO: TFloatField;
