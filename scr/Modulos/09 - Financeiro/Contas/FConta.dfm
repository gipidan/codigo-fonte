object FrmConta: TFrmConta
  ...
  object db_Conta: TUniQuery
    ...
    Left = 352
    Top = 40
    object db_ContaDATA: TDateTimeField
      FieldName = 'DATA'
      EditMask = '99/99/99'
    end
    object db_ContaDATAALTERACAO: TDateTimeField
    ...
    object db_ContaSALDOINICIAL: TFloatField
      FieldName = 'SALDOINICIAL'
      OnChange = db_ContaSALDOINICIALChange
      DisplayFormat = '###,##0.00'
      EditFormat = '###,##0.00'
    end
    object db_ContaSALDOATUAL: TFloatField
      FieldName = 'SALDOATUAL'
      DisplayFormat = '###,##0.00'
      EditFormat = '###,##0.00'
    end
