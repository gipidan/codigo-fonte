object FrmBoletoBancario: TFrmBoletoBancario
  ...
  object db_ViewBoletos: TUniQuery
    Connection = FrmPrincipal.DBConexao
    SQL.Strings = (
    ...
    object db_ViewBoletosDATA: TDateTimeField
      FieldName = 'DATA'
    end
    object db_ViewBoletosVENCIMENTO: TDateTimeField
      FieldName = 'VENCIMENTO'
    end
  ...
  object db_BoletoConfigurar: TUniQuery
    Connection = FrmPrincipal.DBConexao
    SQL.Strings = (
  ...
  object db_CtaReceberBaixar: TUniQuery
    Connection = FrmPrincipal.DBConexao
    SQL.Strings = (
  ...
  object db_ContaCorrenteBoleto: TUniQuery
    Connection = FrmPrincipal.DBConexao
    SQL.Strings = (
  ...
  object db_ViewBoletosRemessas: TUniQuery
    Connection = FrmPrincipal.DBConexao
    SQL.Strings = (
      'SELECT * FROM VIEW_BOLETOS'
      ' WHERE'
    ...
    object db_ViewBoletosRemessasDATA: TDateTimeField
      FieldName = 'DATA'
    end
    object db_ViewBoletosRemessasVENCIMENTO: TDateTimeField
      FieldName = 'VENCIMENTO'
    end
