...
uses
   ...
   ISFEditbtn, ISFdbEditbtn, IDBEdit, uEstSearchDialogZeos, MemDS, DBAccess, Uni,
...
type
   ...
   TFrmBoletoBancario = class(TForm)
    ...
    GridViewBoletos: TDBGrid;
      LblTotal: TLabel;
      db_CtaReceberBaixar: TUniQuery;
      db_ContaCorrenteBoleto: TUniQuery;
      BitBtn1: TBitBtn;
    ...
    dtInicial: TMaskEdit;
    dtFinal: TMaskEdit;
    db_ViewBoletosRemessas: TUniQuery;
    ...
    db_ViewBoletosRemessasDATA: TDateTimeField;
    db_ViewBoletosRemessasVENCIMENTO: TDateTimeField;
    ...
    db_ViewBoletosDATA: TDateTimeField;
    db_ViewBoletosVENCIMENTO: TDateTimeField;
