...
type
   TFrmBordero = class(TForm)
    ...
    db_Bordero: TUniQuery;
    db_BorderoLista: TUniQuery;
    ...
    DBEdit5: TDBEdit;
    Label6: TLabel;
    db_BorderoListaDATA: TDateTimeField;
    db_BorderoListaVENCIMENTO: TDateTimeField;
    ...
    db_somarVALOR: TFloatField;
    db_somarVALORLIQUIDO: TFloatField;
