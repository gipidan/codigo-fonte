object FrmBordero: TFrmBordero
  ...
  object db_BorderoLista: TUniQuery
    Connection = FrmPrincipal.DBConexao
    SQL.Strings = (
    ...
    object db_BorderoListaDATA: TDateTimeField
      FieldName = 'DATA'
      OnChange = db_BorderoListaDATAChange
      EditMask = '99/99/9999'
    end
    object db_BorderoListaVENCIMENTO: TDateTimeField
      FieldName = 'VENCIMENTO'
  ...
  object db_somar: TUniQuery
    ...
    object db_somarVALOR: TFloatField
      FieldName = 'VALOR'
      ReadOnly = True
    end
    object db_somarVALORLIQUIDO: TFloatField
      FieldName = 'VALORLIQUIDO'
      ReadOnly = True
    end
  end
