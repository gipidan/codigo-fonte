...
uses
   ...
   Dialogs, ExtCtrls, StdCtrls, Buttons, DB, MemDS, Uni,
   ComCtrls, DBCtrls, Mask, Grids, DBGrids,  DBAccess;
...
type
   TFrmCartaEmitirGeral = class(TForm)
      ...
      db_InadimplenciaPadrao: TUniQuery;
      btnpadrao: TSpeedButton;
      BitBtn2: TBitBtn;
      BitBtn1: TBitBtn;
      ProgressBar1: TProgressBar;
      ds_Inadimplencia: TDataSource;
      db_InadimplenciaChecar: TUniQuery;
