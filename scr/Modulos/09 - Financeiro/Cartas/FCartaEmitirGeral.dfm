object FrmCartaEmitirGeral: TFrmCartaEmitirGeral
  ...
  object db_EmitirCartas: TUniQuery
  ...
  object db_CartaCadastros: TUniQuery
    Connection = FrmPrincipal.DBConexao
    SQL.Strings = (
  ...
  object db_Inadimplencia: TUniQuery
    Connection = FrmPrincipal.DBConexao
    SQL.Strings = (
  ...
  object db_InadimplenciaPadrao: TUniQuery
    Connection = FrmPrincipal.DBConexao
    SQL.Strings = (
  ...
  object db_InadimplenciaChecar: TUniQuery
    Connection = FrmPrincipal.DBConexao
    SQL.Strings = (
  ...
  object db_InadimplenciaSUM: TUniQuery
    Connection = FrmPrincipal.DBConexao
    SQL.Strings = (
