object FrmCtaReceberBaixasLotesCheques: TFrmCtaReceberBaixasLotesCheques
  ...
  object db_CtaReceberCheque: TUniQuery
    ...
    object db_CtaReceberChequeDATA: TDateTimeField
      FieldName = 'DATA'
      EditMask = '99/99/9999'
    end
    object db_CtaReceberChequeVENCIMENTO: TDateTimeField
      FieldName = 'VENCIMENTO'
      EditMask = '99/99/9999'
    end
    object db_CtaReceberChequeDATA_PAGTO: TDateTimeField
    ...
    object db_CtaReceberChequeDESCONTO_DATA: TDateTimeField
  ...
  object db_CtaReceberChequeSomar: TUniQuery
    Connection = FrmPrincipal.DBConexao
    SQL.Strings = (
