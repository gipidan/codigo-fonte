object FrmCtaReceberBaixas: TFrmCtaReceberBaixas
  ...
  object db_CtaReceber: TUniQuery
    Connection = FrmPrincipal.DBConexao
    Transaction = FrmPrincipal.UniTransaction1
    SQL.Strings = (
    ...
    object db_CtaReceberUSER_DATA: TDateTimeField
      FieldName = 'USER_DATA'
    end
  ...
  object SPFin_CTAReceber_Baixar: TUniStoredProc
    ...
    CommandStoredProcName = 'SPFIN_CTARECEBER_BAIXAR'
  end
end
