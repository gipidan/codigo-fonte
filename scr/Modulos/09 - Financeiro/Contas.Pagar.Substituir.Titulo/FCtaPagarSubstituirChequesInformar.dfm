object FrmCtaPagarSubstituirChequesInformar: TFrmCtaPagarSubstituirChequesInformar
  ...
  object db_CtaPagarCheque: TUniQuery
    ...
    object db_CtaPagarChequeDATA: TDateTimeField
      FieldName = 'DATA'
      EditMask = '99/99/9999'
    end
    object db_CtaPagarChequeVENCIMENTO: TDateTimeField
      FieldName = 'VENCIMENTO'
      EditMask = '99/99/9999'
    end
    object db_CtaPagarChequeDATA_PAGTO: TDateTimeField
    ...
    object db_CtaPagarChequeUSER_DATA: TDateTimeField
      FieldName = 'USER_DATA'
    end
  ...
  object db_CtaPagarChequeSomar: TUniQuery
    Connection = FrmPrincipal.DBConexao
    SQL.Strings = (
