...
uses
  ...
  Dialogs, ExtCtrls, Grids, DBGrids, StdCtrls, DB, MemDS, DBAccess, Uni,
  Vcl.Imaging.jpeg, Classe.Global;
...
type
  TFrmCtaPagarSubstituirChequesInformar = class(TForm)
    ...
    DBGrid1: TDBGrid;
    Panel1: TPanel;
    db_CtaPagarCheque: TUniQuery;
    db_CtaPagarChequeSomar: TUniQuery;
    ...
    db_CtaPagarChequeDATA: TDateTimeField;
    db_CtaPagarChequeVENCIMENTO: TDateTimeField;
    db_CtaPagarChequeDATA_PAGTO: TDateTimeField;
    ...
    db_CtaPagarChequeUSER_DATA: TDateTimeField;
