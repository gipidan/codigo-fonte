...
uses
  ...
  DBCtrls, Buttons, AdvGroupBox, AdvEdit, DBAdvEd, Mask, ISFEdit, ISFEditbtn,
  ISFdbEditbtn, IDBEdit, uEstSearchDialogZeos, Menus, DB, MemDS, DBAccess, Uni,
  frxClass, frxDBSet, Classe.Global;
