...
uses
   ...
   Menus, SysUtils, ComCtrls,  ImgList, BTOdeum,
   Variants, MemDS, Uni,
   ISFEdit, ISFEditbtn, ISFdbEditbtn,
   uEstSearchDialogZeos, IDBEdit, FFrameBotoes_II, FFrameBarra, DBAccess,
   Classe.Global;
...
type
   ...
   TFrmCompras = class(TForm)
      ...
      db_Compras: TUniQuery;
      ds_Compras: TDataSource;
      ds_ComprasItens: TDataSource;
      db_ComprasItens: TUniQuery;
      db_ComprasPedidos: TUniQuery;
      db_ComprasPedidosItens: TUniQuery;
      db_Estoque: TUniQuery;
      ds_ComprasPedidos: TDataSource;
      N6: TMenuItem;
      SP_CalculaItens: TUniStoredProc;
    SPATUALIZA_COMPRA_PRODUTOS: TUniStoredProc;
    SPDELETA_COMPRA_PRODUTOS: TUniStoredProc;
      ...
      enota: TDBEdit;
      DBEdit1: TDBEdit;
      db_ComprasDATA: TDateTimeField;
      db_ComprasDATAENTRADA: TDateTimeField;
      db_ComprasVALIDADE: TDateTimeField;
      db_ComprasItensDATA: TDateTimeField;
      db_ComprasItensDATAENTRADA: TDateTimeField;
      db_ComprasItensVALIDADE: TDateTimeField;
    ...
    SPATUALIZA_COMPRA_GRADE: TUniStoredProc;
    SPPEDIDO_MATERIAPRIMAIMPORTAR: TUniStoredProc;
