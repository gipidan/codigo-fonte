object FrmTabelaPreco: TFrmTabelaPreco
  ...
  object db_TabelaPreco: TUniQuery
    Connection = FrmPrincipal.DBConexao
    SQL.Strings = (
      'SELECT * FROM TPRECO'
      ''
    ...
    object db_TabelaPrecoDATA: TDateTimeField
      FieldName = 'DATA'
      EditMask = '99/99/9999'
    end
    object db_TabelaPrecoDATAREVISAO: TDateTimeField
    ...
    object db_TabelaPrecoVALOR_MIN: TFloatField
      FieldName = 'VALOR_MIN'
    end
    ...
    object db_TabelaPrecoAJUSTE_VALOR: TFloatField
  ...
  object db_ReferenciasImportar: TUniQuery
    Connection = FrmPrincipal.DBConexao
    SQL.Strings = (
  ...
  object DB_ParametrosDescontos: TUniQuery
    Connection = FrmPrincipal.DBConexao
    SQL.Strings = (
  ...
  object db_TabelaReferenciaDeletar: TUniQuery
    Connection = FrmPrincipal.DBConexao
    SQL.Strings = (
  ...
  object db_TabelaDetalhes: TUniQuery
    Connection = FrmPrincipal.DBConexao
    SQL.Strings = (
      'SELECT * FROM TPRECO_REFERENCIAS'
      'WHERE'
