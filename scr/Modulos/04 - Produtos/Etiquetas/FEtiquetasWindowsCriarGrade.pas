...
uses
  ...
  Dialogs, ExtCtrls, StdCtrls, Grids, DBGrids, DBCtrls, Spin, DB, MemDS,
  DBAccess, Uni, ISFEdit, ISFEditbtn, ISFdbEditbtn, IDBEdit,
  uEstSearchDialogZeos, Buttons;
...
type
  TFrmEtiquetasWindowsCriarGrade = class(TForm)
    ...
    dbEtiquetasCor: TUniQuery;
    dbEtiquetasTamanho: TUniQuery;
