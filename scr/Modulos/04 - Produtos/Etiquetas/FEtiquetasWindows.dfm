object FrmEtiquetasWindows: TFrmEtiquetasWindows
  ...
  object dbEtiquetasTamanho: TUniQuery
    Connection = FrmPrincipal.DBConexao
    SQL.Strings = (
  ...
  object dbEtiquetasCor: TUniQuery
    Connection = FrmPrincipal.DBConexao
    SQL.Strings = (
  ...
  object db_TipoProduto: TUniQuery
    Connection = FrmPrincipal.DBConexao
    SQL.Strings = (
