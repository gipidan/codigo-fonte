...
uses
   ...
   MemDS, Uni,  DBAccess, ComCtrls, StdCtrls, Buttons, ISFEdit, ISFEditbtn,
...
type
   TFrmOrdemProducaoMateriaPrimaBaixar = class(TForm)
    ...
    Button2: TButton;
    Button3: TButton;
    SP_BaixarEstoque: TUniStoredProc;
    Panel3: TPanel;
    ...
    db_MateriaPrimaOrigem: TUniQuery;
