...
uses
  ...
  Dialogs, ExtCtrls, FFrameBarra, StdCtrls, Buttons, Grids, AdvObj, BaseGrid,
  AdvGrid, DBAdvGrid, AdvGroupBox, Mask, Uni, DB, MemDS, DBAccess, ISFEdit,
  ISFEditbtn, ISFdbEditbtn, IDBEdit, uEstSearchDialogZeos, DBCtrls, DBCGrids,
  Menus, DBGrids, frxClass, frxDBSet, Classe.Global;
...
type
  TFrmFaseProducao = class(TForm)
    ...
    db_OrdemProducaoFases: TUniQuery;
    ds_OrdemProducaoFases: TDataSource;
    db_FasesDestino: TUniQuery;
    ds_FasesDestino: TDataSource;
    db_ReferenciasFaseGrade: TUniQuery;
