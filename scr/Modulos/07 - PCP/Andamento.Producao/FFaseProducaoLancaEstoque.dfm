object FrmFaseProducaoLancaEstoque: TFrmFaseProducaoLancaEstoque
  ...
  object SP_OrdemProducaoFinalizar: TUniStoredProc
    ...
    CommandStoredProcName = 'SPPCP_FINALIZAR;1'
  end
  object SP_ReferenciaLancaGrade: TUniStoredProc
    ...
    CommandStoredProcName = 'SPSPPRODUTOS_LANCAGRADE;1'
  end
  object db_OrdemProducaoProduzido: TUniQuery
    Connection = FrmPrincipal.DBConexao
    SQL.Strings = (
    ...
    object db_OrdemProducaoProduzidoDATA: TDateTimeField
      FieldName = 'DATA'
      Required = True
    end
    object db_OrdemProducaoProduzidoDATAATUALIZACAO: TDateTimeField
  ...
  object db_ProduzidosDeletarPendencia: TUniQuery
    Connection = FrmPrincipal.DBConexao
    SQL.Strings = (
