...
uses
  ...
  Dialogs, ExtCtrls, Grids, DBGrids, StdCtrls, Buttons, DB, MemDS, DBAccess, Uni,
  FFrameBarra;
...
type
  TFrmFaseProducaoSelecionar = class(TForm)
    ...
    db_DeletarDATARETORNOORIGEM: TDateTimeField;
