...
type
   TFrmRelatorioProducao = class(TForm)
    ...
    db_FasesLocalizacao: TUniQuery;
    frxdb_FasesLocalizacao: TfrxDBDataset;
    SP_GerarNecessidades: TUniStoredProc;
