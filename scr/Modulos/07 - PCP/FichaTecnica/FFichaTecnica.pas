...
uses
   ...
   uEstSearchDialogZeos, IDBEdit, MemDS, Uni,
   AdvSplitter, BaseGrid, AdvGrid, frxClass, frxDBSet, AdvObj, DBAccess,
...
type
   ...
   TFrmFichaTecnica = class(TForm)
    ...
    GridMaquinas: TDBGrid;
      ...
      db_view_referencias: TUniQuery;
      tds_ViewReferencia: TfrxDBDataset;
      db_ReferenciaGrade: TUniQuery;
    ...
    SP_MarkupAplicar: TUniStoredProc;
