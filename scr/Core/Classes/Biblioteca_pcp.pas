...
uses DBTables, Forms, Classes, Windows, Controls, Variants, ComCtrls,
   ...
   BDE, Sysutils, DBGrids,
   DBClient, SimpleDS, MemDS, Uni,
   Classe.Global;
...
Begin
   ...
   TblPrecoReferencia := TUniQuery.Create(Application);
...
begin
   ...
   TabelaGrades := TUniQuery.Create(Application);
   TabelaCores := TUniQuery.Create(Application);
   TabelaTamanhos := TUniQuery.Create(Application);
...
begin
   ...
   TabelaArmazenar := TUniQuery.Create(Application);
