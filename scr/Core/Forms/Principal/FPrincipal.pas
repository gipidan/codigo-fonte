...
uses
  ...
  Vcl.Buttons, Vcl.ExtCtrls, ExeInfo, AdvOfficeStatusBar,
  AdvOfficeStatusBarStylers, DBAccess, Uni, UniDacVcl, UniProvider,
  SQLServerUniProvider, Data.DB, BTOdeum, Vcl.ImgList,
  ...
  Vcl.Imaging.jpeg, System.Actions;
...
type
   TFrmPrincipal = class(TForm)
    ...
    imgMenusImagens32x: TImageList;
      ...
      stbBarraStatus: TAdvOfficeStatusBar;
    ...
    DBConexaoDialogo: TUniConnectDialog;
...
begin
   ...
   DBConexao.Database  := FBancoDados.Nome;
   DBConexao.Server    := FBancoDados.Endereco;
   DBConexao.Port      := FBancoDados.Porta;
   DBConexao.Password  := FBancoDados.Senha;
