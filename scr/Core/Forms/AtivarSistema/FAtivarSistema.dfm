object FrmAtivarSistema: TFrmAtivarSistema
  ...
  object db_AtivacaoRemota: TUniQuery
    ...
    object db_AtivacaoRemotaultimo_acesso: TDateTimeField
  ...
  object DBConexaoRemota: TUniConnection
    ProviderName = 'mysql-5'
    BeforeConnect = DBConexaoRemotaBeforeConnect
    Left = 96
    Top = 48
  end
  object db_AtivacaoLocal: TUniQuery
