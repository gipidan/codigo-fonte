object BaseDados: TBaseDados
  ...
  Height = 506
  Width = 822
  object db_Parametros: TUniQuery
  ...
  object db_ctaReceber: TUniQuery
    ...
    object db_ctaReceberDATA: TDateTimeField
      FieldName = 'DATA'
      EditMask = '99/99/9999'
    end
    object db_ctaReceberVENCIMENTO: TDateTimeField
      FieldName = 'VENCIMENTO'
      EditMask = '99/99/9999'
    end
    object db_ctaReceberDATA_PAGTO: TDateTimeField
    ...
    object db_ctaReceberDESCONTO_DATA: TDateTimeField
  ...
  object db_Clientes: TUniQuery
    ...
    object db_ClientesDATA: TDateTimeField
      FieldName = 'DATA'
      EditMask = '99/99/9999'
    end
    object db_ClientesDATA_NASCIMENTO: TDateTimeField
    ...
    object db_ClientesCREDITO_LIMITE: TFloatField
      FieldName = 'CREDITO_LIMITE'
      DisplayFormat = '###,##0.00'
    end
    object db_ClientesCREDITO_UTILIZADO: TFloatField
      FieldName = 'CREDITO_UTILIZADO'
      DisplayFormat = '###,##0.00'
    end
    object db_ClientesCREDITO_DISPONIVEL: TFloatField
    ...
    object db_ClientesPROTESTO_DATA: TDateTimeField
    ...
    object db_ClientesATIVODATA: TDateTimeField
      FieldName = 'ATIVODATA'
      EditMask = '99/99/9999'
    end
    ...
    object db_ClientesCONJUGE_SALARIO: TFloatField
    ...
    object db_ClientesEMPREGO_SALARIO: TFloatField
      FieldName = 'EMPREGO_SALARIO'
    end
    object db_ClientesCOMISSAO: TFloatField
      FieldName = 'COMISSAO'
      DisplayFormat = '###,##0.00%'
    end
    ...
    object db_ClientesSALARIO: TFloatField
      FieldName = 'SALARIO'
      DisplayFormat = '###,##0.00'
    end
    ...
    object db_ClientesULTIMAVENDA_DATA: TDateTimeField
  ...
  object db_UsuarioLog: TUniQuery
    Connection = FrmPrincipal.DBConexao
    SQL.Strings = (
  ...
  object db_Vendas: TUniQuery
    ...
    object db_VendasEMISSAO: TDateTimeField
      FieldName = 'EMISSAO'
      Required = True
    ...
    object db_VendasDATA_ENTRADASAIDA: TDateTimeField
    ...
    object db_VendasICMS_BASECALCULO_SUBSTITUICAO_VALOR: TFloatField
    ...
    object db_VendasNFE_DATATRANSMISSAO: TDateTimeField
    ...
    object db_VendasCANCELAMENTO_DATA: TDateTimeField
  ...
  object db_VendasItens: TUniQuery
    Connection = FrmPrincipal.DBConexao
    SQL.Strings = (
    ...
    object db_VendasItensEMISSAO: TDateTimeField
      FieldName = 'EMISSAO'
      Required = True
    end
  ...
  object SP_NFE_CALCULA: TUniStoredProc
    ...
    CommandStoredProcName = 'SPNFE_CALCULA'
  end
  object SPNFE_PROCESSAR: TUniStoredProc
    ...
    CommandStoredProcName = 'SPNFE_PROCESSAR'
  end
  ...
  object db_VendasDevolucaoItens: TUniQuery
    KeyFields = 'CODIGO;EMPRESA'
    Connection = FrmPrincipal.DBConexao
    SQL.Strings = (
    ...
    object db_VendasDevolucaoItensEMISSAO: TDateTimeField
      FieldName = 'EMISSAO'
      Required = True
    end
  ...
  object db_PedidoCompra: TUniQuery
    Connection = FrmPrincipal.DBConexao
    SQL.Strings = (
    ...
    object db_PedidoCompraDATA: TDateTimeField
      FieldName = 'DATA'
      EditMask = '99/99/9999'
    end
    object db_PedidoCompraDATA_ENTREGA: TDateTimeField
  ...
  object db_PedidoCompraItens: TUniQuery
    Connection = FrmPrincipal.DBConexao
    SQL.Strings = (
  ...
  object SPPEDIDOCOMPRA_CALCULAR: TUniStoredProc
    ...
    CommandStoredProcName = 'SPPEDIDOCOMPRA_CALCULAR'
  end
