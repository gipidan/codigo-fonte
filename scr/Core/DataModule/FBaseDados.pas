...
uses
  ...
  ACBrNFe, frxClass, frxDBSet, Uni, MemDS,  DBAccess, ACBrNFeUtil,
  ACBrNFeDANFEClass, ACBrNFeDANFEFR, Classe.Global;
...
type
   TBaseDados = class(TDataModule)
    ...
    SPNFE_PROCESSAR: TUniStoredProc;
      ...
      db_ClientesCREDITO_LIMITE: TFloatField;
      db_ClientesCREDITO_UTILIZADO: TFloatField;
      db_ClientesCREDITO_DISPONIVEL: TFloatField;
      ...
      db_ClientesCONJUGE_SALARIO: TFloatField;
      ...
      db_ClientesEMPREGO_SALARIO: TFloatField;
      db_ClientesCOMISSAO: TFloatField;
      db_ClientesCOMISSIONAR: TStringField;
      db_ClientesSALARIO: TFloatField;
      ...
      db_ClientesDATA: TDateTimeField;
      db_ClientesDATA_NASCIMENTO: TDateTimeField;
      db_ClientesPROTESTO_DATA: TDateTimeField;
    ...
    db_VendasDATA_ENTRADASAIDA: TDateTimeField;
    ...
    db_VendasICMS_BASECALCULO_SUBSTITUICAO_VALOR: TFloatField;
    ...
    db_PedidoCompra: TUniQuery;
    db_PedidoCompraItens: TUniQuery;
    db_PedidoCompraEMPRESA: TIntegerField;
    db_PedidoCompraCODIGO: TIntegerField;
    db_PedidoCompraDATA: TDateTimeField;
    db_PedidoCompraDATA_ENTREGA: TDateTimeField;
    ...
    SPPEDIDOCOMPRA_CALCULAR: TUniStoredProc;
    ...
    db_ClientesULTIMAVENDA_DATA: TDateTimeField;
    db_ClientesATIVODATA: TDateTimeField;
    ...
    db_VendasNFE_DATATRANSMISSAO: TDateTimeField;
    ...
    db_VendasCANCELAMENTO_DATA: TDateTimeField;
